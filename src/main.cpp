...
void setup() {
    ...
    tileLeftObject = TwoDRObject(3, 11, oledDisplay);
    tileRightObject = TwoDRObject(3, 11, oledDisplay);
    ...
    tileLeft = {tileLeftObject, UP};
    tileRight = {tileRightObject, UP};

    topBorderObject = TwoDRObject(OLED_WIDTH - 1, 1, oledDisplay);
    bottomBorderObject = TwoDRObject(OLED_WIDTH - 1, 1, oledDisplay);
    leftBorderObject = TwoDRObject(1, OLED_HEIGHT - 2 - 1, oledDisplay);
    rightBorderObject = TwoDRObject(1, OLED_HEIGHT - 2 - 1, oledDisplay);
...
void moveTile(Tile& tile) {
    if (tile.object.isUpMoveCollision(topBorderObject)) {
